...
// TODO: Replace these example ImgBB URLs with your own links
...
export default function HomePage() {
  ...
  // which image index is currently visible for each row
  ...
  return (
    ...
    >
      <style jsx global>{`
        ...
        /* 🔹 Responsive grid for showcase rows
           - auto-fit makes it use all available width (no empty columns)
           - min 140px ensures at least 2 columns on phones, more on PC
        */
        .showcase-grid {
          display: grid;
          gap: 12px;
          ...
          <section className="options-grid" style={{ marginBottom: 64 }}>
            ...
            <Link href="/ai-image" style={{ textDecoration: "none" }}>
              ...
              >
                ...
                >
                  Use MythFlair&apos;s free AI image creator, powered by Flux.1,
            ...
            >
              ...
              >
                Create short AI-powered videos and earn extra premium minutes by
                watching ads.
              </p>
              ...
              >
                <div style={{ flex: 1, zIndex: 1, minWidth: 240 }}>
                  ...
                  >
                    ...
                    experiences. Select from multiple lifelike voices and export
                    your audio instantly.
                  </p>
                  <span
                    style={{
                      padding: "8px 18px",
